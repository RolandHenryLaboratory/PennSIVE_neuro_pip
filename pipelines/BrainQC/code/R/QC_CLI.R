...
p <- add_argument(p, "--stage", help = "specify the stage of this pipeline. prep: prepare results for evaluation; qc: run interactive QC App.", default = "prep")
...
p <- add_argument(p, "--type", help = "specify the type of qc procedure.", default = "lesion")
